...
export default function Navbar(props) {
    ...
    return (
        <>
            ...
            <Link to="accueil" spy={true} smooth={true}><img style={{cursor:'pointer',marginLeft:"60px"}} src={require("../../assets/img/logo/logo1.png").default} alt="logo-evenement" className='logo' /></Link>
                <Container >
